...
async function getLeaderboard(){
    ...
    for( var i=0; i<data.length;i++){
        document.getElementById(i+1).innerHTML="<div class=\"username\">"+data[i].player.username+"</div><div class=\"score\">"+data[i].player.xp+"</div>"
    }
    ...
    document.getElementById("coins-number").textContent=localStorage.getItem("user_coins");
    document.getElementById("xp-number").textContent=localStorage.getItem("user_xp");
